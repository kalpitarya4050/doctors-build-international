...
import { OWNED_UNI_LOGOS } from "@/lib/data/owned-photos";
...
export function UniversityLogo({
  ...
  // The owned overlay first: university-logos.ts is regenerated by
  // `npm run images:logos`, so a mark the client supplied directly
  // would be dropped on the next run if it lived only there.
  const logo = OWNED_UNI_LOGOS[slug] ?? UNIVERSITY_LOGOS[slug];
